...
{
    /**
     * @Route("/", name="category_dishes_index", methods={"GET"})
     */
    public function index(CategoryDishesRepository $categoryDishesRepository): Response
    {
        return $this->render('category_dishes/index.html.twig', [
